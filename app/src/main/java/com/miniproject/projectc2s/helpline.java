...
public class helpline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addNewContactFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(helpline.this, CreateNewContactActivity.class);
                startActivity(i);
            }
        });
    }
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport multiplePermissionsReport) {
                        ...
                        if (multiplePermissionsReport.areAllPermissionsGranted()) {
                            // do you work now
                            getContacts();
                            Toast.makeText(helpline.this, "All the permissions are granted..", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void showSettingsDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(helpline.this);
